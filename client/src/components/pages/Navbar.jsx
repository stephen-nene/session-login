...
function Navbar({ loggedIn }) {
    ...
    return (
        <nav className={`${darkMode ? "bg-blue-900 text-white" : "bg-blue-500"}  p-2 sticky top-0 z-50`}>
            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="md:hidden m-2">
                    ...
                    {isOpen ?
                        <HiMenuAlt1 className="hover:cursor-pointer" onClick={() => setIsOpen(!isOpen)} size={35} />
                        :
                        <VscChromeClose className="hover:cursor-pointer" onClick={() => setIsOpen(!isOpen)} size={40} />
                    }
                </div>

                <div className={`${darkMode ? "bg-blue-900 text-white" : "bg-blue-500"}  ${isOpen ? "hidden md:block" : ""} absolute md:static  p-5  m:min-h-[20vh] left-0 top-[70px] w-full`}>
                    {loggedIn ? (
                        <>
...
s
                ...
                <div className="right flex items-center gap-6 text-3xl">
                    ...
                    {darkMode ?
                        <BsFillSunFill className='text-white' onClick={() => { dispatch(setDarkMode()) }} />
                        :
                        <BsMoonStarsFill onClick={() => { dispatch(setDarkMode()) }} />
                    }
